...
import { DEMO_ACCOUNT, DEMO_PROFILE, DEMO_USER } from "@/lib/demo/demo-data";
import {
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const isDemoMode =
      ...
      (localStorage.getItem("wacrm_demo_mode") === "true" ||
  ...
  const signOut = useCallback(async () => {
    ...
    if (typeof window !== "undefined") {
      ...
      document.cookie = "wacrm_auth=; path=/; max-age=0; SameSite=None; Secure";
    }
    setUser(null);
    setProfile(null);
    setAccount(null);
